...
We created a multi-disciplinary team and immediately decided to iterate through [six sprints](https://github.com/CivicActions/flash/blob/master/documentation/journal.md) in the
...
We maintained a disciplined process, holding [formal demos](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-interviews/log-of-sprint-demos.md) and [retrospectives](https://github.com/CivicActions/flash/tree/master/call-notes)
with each sprint, and a complete story board manipulated with [Waffle](https://github.com/CivicActions/flash/tree/master/call-notes/waffle-shots)
overlaying our [GitHub](https://github.com/CivicActions/flash) Issues and Stories.

As we have done before, we [closely followed the USDS checklist](https://github.com/CivicActions/flash/blob/master/documentation/usds-checklist.md).

## The User-Centered Approach

Knowing very little about the subject of foster children but having found real users, we wrote open-ended [scripts](https://github.com/CivicActions/flash/tree/master/documentation/ux/user-interviews/Scripts).
We began our four [user interviews](https://github.com/CivicActions/flash/tree/master/documentation/ux/user-interviews) of one case worker and three foster parents. From these interviews we built an [empathy map](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-research/foster-parent-empathy-map.md) and [personae](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-research/user-personas.md).
We then organized an informal design studio and began mocking up [sketches and wirefames](https://github.com/CivicActions/flash/blob/master/documentation/images/Sketch-inbox01.png) that we could show to users to get feedback.
...
We demonstrated wireframes to users in [Sprint 3](https://github.com/CivicActions/flash/blob/master/documentation/journal.md#sprint-3).
...
We created a "spike" [solution](https://github.com/CivicActions/flash/tree/master/geojson-spike) to test our ability to render a map before integrating it into our main code.

As our understanding grew we kept our [story map](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-story-map/user-story-map.md) up to date.
...
We also learned that classifying messages as being related to visitation or medical incidents is extremely important, so we wrote user stories to capture that and placed them into our constantly-evolving [backlog](https://github.com/CivicActions/flash/issues), but were not able to complete them.
...
By [Sprint 5](https://github.com/CivicActions/flash/blob/master/documentation/journal.md#sprint-5) we had a functional prototype demoed to both a foster parent and a case worker.
A foster parent provided user testing of our deployed prototype and [extensive feedback](https://github.com/CivicActions/flash/blob/master/documentation/ux/usability-testing/2016-6-03-notes-from-foster-parent-usabiliy-tester.md) during Sprint 6.

In sum, our team spent over four hours discussing this product with potential users, both in our [initial interviews](https://github.com/CivicActions/flash/tree/master/documentation/ux/user-interviews) and in our [sprint demos](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-interviews/log-of-sprint-demos.md).
...
[USDS checklist](https://github.com/CivicActions/flash/blob/master/documentation/usds-checklist.md)
...
1. [User Interviews](https://github.com/CivicActions/flash/tree/master/documentation/ux/user-interviews)
2. [Personae](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-research/user-personas.md)
3. [Empathy Map](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-research/foster-parent-empathy-map.md)
4. [Story Map](https://github.com/CivicActions/flash/blob/master/documentation/ux/user-story-map/user-story-map.md)
5. [Design Studio](https://github.com/CivicActions/flash/tree/master/documentation/ux/wireframes)
6. [Wireframes](https://github.com/CivicActions/flash/tree/master/documentation/ux/wireframes)
...
p. The [devops-manual](https://github.com/CivicActions/flash/blob/master/documentation/devops-manual.md) describes how to install and run the prototype on a local sandbox, deploy the application to AWS and configure a continuous delivery (integrated testing and deployment) automation job.
